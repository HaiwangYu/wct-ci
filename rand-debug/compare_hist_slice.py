...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=[
            ...
            # base_dir / "test38.root",
            # base_dir / "test39.root",
            # base_dir / "test41.root",
            # base_dir / "test42.root",
            # base_dir / "test43.root",
            # base_dir / "test44.root",
            # base_dir / "test45.root",
            # base_dir / "test46.root",
            # base_dir / "test47.root",
            base_dir / "test48.root",
            base_dir / "test49.root",
        ],

...
local runDate = "09072025";
local angleXZ_deg = 85;
local thetaXZ = angleXZ_deg * wc.deg;
...
local magoutput = 'pdhd-sim-check-deposplat_apa_01_trk_xz' + std.toString(angleXZ_deg) + '_' + runDate + '.root';

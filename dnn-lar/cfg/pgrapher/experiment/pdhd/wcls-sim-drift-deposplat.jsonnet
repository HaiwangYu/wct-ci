...
local ts = {
    ...
    data: {
        ...
        // model: "ts-model/CP28_my_unet.ts",
        // model: "ts-model/CP49_mobilenetv2.ts",
        // model: "ts-model/CP49_mobilenetv3.ts",
        // model: "ts-model/CP32_transformer.ts",
        // model: "ts-model/CP49_mobilenetv3_rebin10_lr0p1_thr10.ts",
        // model: "ts-model/CP49_mobilenetv3_rebin10_lr0p1_thr25.ts",
        // model: "ts-model/CP49_mobilenetv3_rebin10_lr0p1_thr50.ts",
        // model: "ts-model/CP49_mobilenetv3_rebin10_lr0p1_thr75.ts",
        // model: "ts-model/CP49_mobilenetv3_rebin10_lr0p1_thr100.ts",

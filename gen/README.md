Signal:
```
wire-cell -l stdout -L debug -c check_pdsp_sim.jsonnet -V input=depos.tar.bz2 -V output=sn-22154a5.tar.bz2
wirecell-plot frame -n wave --interactive sn-22154a5.tar.bz2 tmp.pdf
wirecell-plot comp1d -n spec --chmin 1600 --chmax 2080 --interactive -o tmp.pdf --transform="median" sn-0.20.0.tar.bz2 sn-22154a5.tar.bz2
wirecell-plot comp1d -n wave --chmin 700 --chmax 701 --interactive -o tmp.pdf --transform="median" sn-0.20.0.tar.bz2 sn-22154a5.tar.bz2
wirecell-plot comp1d -n wave --chmin 2300 --chmax 2301 --interactive -o tmp.pdf --transform="median" sn-0.20.0.tar.bz2 sn-22154a5.tar.bz2
```
